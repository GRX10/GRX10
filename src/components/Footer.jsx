      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-6 md:px-8 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_2fr] gap-8 md:gap-10 lg:gap-12 mb-12">
          ...
          <div className="footer-right">
            ...
            <div className="flex gap-4 mt-6">
              <a href="#instagram" className="w-[35px] h-[35px] bg-transparent border border-white/30 rounded-md flex items-center justify-center text-sm font-bold text-white transition-all duration-300 hover:bg-[#E1198B] hover:border-[#E1198B]">
              ...
              <a href="#linkedin" className="w-[35px] h-[35px] bg-transparent border border-white/30 rounded-md flex items-center justify-center text-sm font-bold text-white transition-all duration-300 hover:bg-[#E1198B] hover:border-[#E1198B]">
                in
              </a>
              <a href="#youtube" className="w-[35px] h-[35px] bg-transparent border border-white/30 rounded-md flex items-center justify-center text-sm font-bold text-white transition-all duration-300 hover:bg-[#E1198B] hover:border-[#E1198B]">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-text-gray text-sm gap-6 md:gap-0 text-center md:text-left">
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center">
            ...
            <a href="#privacy" className="text-white no-underline transition-colors duration-300 text-sm hover:text-[#E1198B]">
              Privacy Policy
            </a>
